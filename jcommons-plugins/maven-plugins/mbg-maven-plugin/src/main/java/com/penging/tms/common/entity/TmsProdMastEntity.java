...
public class TmsProdMastEntity {
    private Long codId;
    ...
    private BigDecimal amtProdPrincRecover;
    ...
    public BigDecimal getAmtProdPrincRecover() {
        return amtProdPrincRecover;
    }

    public void setAmtProdPrincRecover(BigDecimal amtProdPrincRecover) {
        this.amtProdPrincRecover = amtProdPrincRecover;
    }
